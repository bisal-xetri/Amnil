...
// // Use the fetch function to make a request
// fetch(apiUrl)
//   .then((response) => {
...
// for (let index in products) {
//   const objects = products[index];
//   //loping over objects
//   for (let key in objects) {
//     //looping over nested objects
//     const nested = objects[key];
...
const removingFirstElement = products.shift();
// console.log(removingFirstElement);

//filter
const filterProductBasedOnPrice = products.filter(
  (product) => product.price > 100 && product.rating > 3
);

// console.log(filterProductBasedOnPrice);

//reduce
const totalFilterProductPrice = filterProductBasedOnPrice.reduce(
  (total, item) => total + item.price,
  0
);
// console.log(totalFilterProductPrice.toFixed(2));
const flattenedTags = products.reduce((acc, product) => {
...
const getAllReviews = products.map((product) => product.reviews);
console.log(getAllReviews);

// const reviews = getAllReviews.map((review, i) => review[i]);
// console.log(reviews);

// const findIndex = products.findIndex((product) => product.price === 2.49);
// console.log("Result of index of", findIndex);
// const numbers = [10, 20, 30, 20];
// const index = numbers.findIndex((num) => num === 30);
// console.log(index);

//find() Returns the first element that matches a condition.
const finds = products.find((product) => product.id === 3);
console.log(typeof finds);
...
console.log(allExpensive); // true or false
//Check if any product is below a certain price:
const anyCheapProduct = products.some((product) => product.price < 10);
console.log(anyCheapProduct); // true or false
